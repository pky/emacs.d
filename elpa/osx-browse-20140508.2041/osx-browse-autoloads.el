;;; osx-browse-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(let ((loads (get 'osx-browse 'custom-loads))) (if (member '"osx-browse" loads) nil (put 'osx-browse 'custom-loads (cons '"osx-browse" loads)) (put 'external 'custom-loads (cons 'osx-browse (get 'external 'custom-loads)))))
(let ((loads (get 'osx-browse-keys 'custom-loads))) (if (member '"osx-browse" loads) nil (put 'osx-browse-keys 'custom-loads (cons '"osx-browse" loads)) (put 'osx-browse 'custom-loads (cons 'osx-browse-keys (get 'osx-browse 'custom-loads)))))
...
`Osx-Browse mode' mode.  If the prefix argument is positive,
...
evaluate `(default-value \\='osx-browse-mode)'.
...
(fn URL &optional NEW-WINDOW BROWSER FOCUS)" t)
...
(fn TEXT &optional NEW-WINDOW BROWSER FOCUS SEARCH-URL)" t)
...
(fn URL &optional NEW-WINDOW BROWSER FOCUS)" t)
(register-definition-prefixes "osx-browse" '("osx-browse-"))

;;; End of scraped data
