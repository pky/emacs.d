;;; browse-url-dwim-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(let ((loads (get 'browse-url-dwim 'custom-loads))) (if (member '"browse-url-dwim" loads) nil (put 'browse-url-dwim 'custom-loads (cons '"browse-url-dwim" loads)) (put 'external 'custom-loads (cons 'browse-url-dwim (get 'external 'custom-loads)))))
(let ((loads (get 'browse-url-dwim-keys 'custom-loads))) (if (member '"browse-url-dwim" loads) nil (put 'browse-url-dwim-keys 'custom-loads (cons '"browse-url-dwim" loads)) (put 'browse-url-dwim 'custom-loads (cons 'browse-url-dwim-keys (get 'browse-url-dwim 'custom-loads)))))
...
(fn &optional TEXT SEARCH-URL GUESS)" t)
